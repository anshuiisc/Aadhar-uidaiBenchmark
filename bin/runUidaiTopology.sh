...
#pythonFile=$baseDirectory"/data/enroll/scripts/eventGen.py"
#python pythonFile
...
# Path of events file
dataPath=$baseDirectory"/data/enroll/input/eventDist.csv"

# Path where all output files will be kept
outputPath=$baseDirectory"/data/enroll/output"

# Topology name
topologyName="UIDAI_Enroll_Topology"
...
storm jar $stormJarPath in.dream_lab.bm.uidai.enroll.topology.$topologyName $mode $topologyName $dataPath UIDAI-$expNum 1.0 $outputPath
