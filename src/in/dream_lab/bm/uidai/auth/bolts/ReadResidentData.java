...
public class ReadResidentData implements IRichBolt {
    private final String experiRunId;
    OutputCollector _collector;
    int count = 1;

    public ReadResidentData(String sinkLogFileName) {
    ...
    public void execute(Tuple tuple) {
        LatencyConfig.sleepFortime(LatencyConfig.READ_RESIDENT_DATA_LATENCY);
