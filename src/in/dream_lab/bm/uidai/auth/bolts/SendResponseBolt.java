...
public class SendResponseBolt implements IRichBolt {
    private final String experiRunId;
    OutputCollector _collector;
    int count = 1;

    public SendResponseBolt(String sinkLogFileName) {
    ...
    public void execute(Tuple tuple) {
        LatencyConfig.sleepFortime(LatencyConfig.SEND_RESPONSE_LATENCY);
