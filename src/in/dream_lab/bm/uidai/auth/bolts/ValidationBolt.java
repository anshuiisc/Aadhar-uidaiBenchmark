...
public class ValidationBolt implements IRichBolt {
    private final String experiRunId;
    OutputCollector _collector;
    int count=1;

    public ValidationBolt(String sinkLogFileName) {
    ...
    public void execute(Tuple tuple) {
        LatencyConfig.sleepFortime(LatencyConfig.VALIDATION_LATENCY);
